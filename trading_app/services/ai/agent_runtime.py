...
from trading_app.services.agent_evidence_service import AgentEvidenceService, EvidenceBundle, EvidenceItem
from trading_app.services.agent_response_contract import build_contract_with_citations
...
class StockAgentRuntime:
    ...
    def __init__(
        ...
        self.tool_registry = tool_registry or build_default_stock_tool_registry()
    ...
    def prepare_request(
        ...
        *,
        ...
        tool_results = self._run_tools(tool_plan, execution_context)
        evidence_items = [
            EvidenceItem(
        ...
        return PreparedAgentRequest(
            ...
            executed_tools=[result.tool_name for result in tool_results],
            evidence_items=evidence_items,
            evidence_report_path=evidence_report_path,
        )
    ...
    def _build_tool_plan(
        ...
        codes = extract_symbol_codes(user_text)
