...
_CONFIG_PATH = Path(__file__).resolve().parent.parent / "config" / "stock_pool_config.json"
_SNAPSHOT_PATH = Path(__file__).resolve().parent.parent / "data" / "daily_candidate_pool.json"
